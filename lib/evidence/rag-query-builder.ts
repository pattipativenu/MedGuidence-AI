...
const DOCTOR_MODE_SCENARIOS: Record<string, any> = {
  ...
  hfpef: {
    guidelines: [
      "HFpEF management guideline 2022 2023 2025",
  ...
  af_anticoagulation: {
    guidelines: [
      "atrial fibrillation anticoagulation guideline ACC AHA ESC 2023 2025",
  ...
  if (mode === 'doctor') {
    ...
    return {
      guidelineQueries: [
        ...
        `${diseaseQuery} management guideline 2022 2023 2025`,
