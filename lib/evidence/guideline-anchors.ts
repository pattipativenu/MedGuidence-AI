...
export const ANCHOR_GUIDELINES: Record<string, ClinicalScenario> = {
  ...
  cancer_vte_thrombocytopenia: {
    ...
    primaryGuidelines: [
      ...
      {
        name: 'Extended Reduced-Dose Apixaban for Cancer-Associated VTE (2025 NEJM)',
        organization: 'New England Journal of Medicine',
        year: 2025,
        url: 'https://pubmed.ncbi.nlm.nih.gov/39788934',
        citation: '[Extended Reduced-Dose Apixaban for Cancer-Associated VTE (2025 NEJM)](https://pubmed.ncbi.nlm.nih.gov/39788934)',
        pmid: '39788934',
  ...
  sepsis: {
    keywords: ['sepsis', 'septic shock', 'severe infection', 'sepsis bundle'],
    condition: 'sepsis',
    context: 'severe/ICU',
    decisionType: 'initial-therapy;duration;de-escalation',
    microprompt: `For sepsis antibiotic questions, include:
1) Initial therapy: Broad-spectrum antibiotics within 1 hour of sepsis recognition.
2) De-escalation: Daily assessment for narrowing based on culture results (typically 48-72h).
3) Duration: 7-10 days for most infections; shorter (5-7 days) if good source control and rapid clinical response.
4) Procalcitonin: Can guide discontinuation (weak recommendation, Level 2B).
5) Cite Surviving Sepsis Campaign 2021 as primary source.`,
    primaryGuidelines: [
      {
        ...
        keyRecommendations: [
          ...
          'Rapid administration of 30 mL/kg crystalloid for hypotension or lactate ≥2 mmol/L',
          ...
          'Procalcitonin plus clinical evaluation to guide discontinuation',
  ...
  glp1_t2dm_ckd: {
    ...
    primaryGuidelines: [
      ...
      {
        name: '2025 ADA Standards of Medical Care in Diabetes',
        organization: 'American Diabetes Association',
        year: 2025,
        url: 'https://diabetesjournals.org/care/issue/47/Supplement_1',
        citation: '[2025 ADA Standards of Medical Care in Diabetes](https://diabetesjournals.org/care/article-lookup/doi/10.2337/dc24-S009)',
